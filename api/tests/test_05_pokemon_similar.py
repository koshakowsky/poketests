...
@pytest.mark.p0
def test_similar_for_existing_pokemon(api):
    """TC-SIM-01: default limit=10, item shape, sorted by score (shape test)."""
    r = api.get("pokemon/1/similar")
...
@pytest.mark.p0
def test_similar_not_found(api):
    """TC-SIM-05: unknown pokemon -> 404."""
    r = api.get("pokemon/999999/similar")
